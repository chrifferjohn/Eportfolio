...
<body>
	<form method="post">
<button type="submit" name="button" value="set">SET Goal</button>
<button type="submit" name="button" value="var">Variables</button>
<button type="submit"><a href="button2.php">Area of Shape</a> </button>
</form>
...
if ($button=="set"){
	echo"The School of Engineering and Technology aims to produce professionals and competent individuals with broad skills set in the industry";
}
elseif($button =="var"){
	$c ="a";
	$s ="lugatiman";
